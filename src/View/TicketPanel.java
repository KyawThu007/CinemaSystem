...
public class TicketPanel extends javax.swing.JPanel {
    ...
    private void getAllTicketAction() {
        ...
        List<Ticket> list = new TicketImp().getAllShowTicket(cinema_id, startDate, endDate);
        ...
        for (Ticket ticket : list) {
            Show show = new ShowImp().getShowMovie(ticket.getShow_id());
            Movie movie = new MovieImp().getMovie(show.getMovie_id());
            Room room = new RoomImp().getRoom(show.getRoom_id());
            Cinema cinema = new CinemaImp().getCinema(show.getCinema_id());
